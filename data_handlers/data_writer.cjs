module.exports = {
    ...
    writeInt: require('./int/int.cjs').Write,
    writeUInt: require('./uint/uint.cjs').Write,
    writeLong: require('./long/long.cjs').Write,
    writeFloat: require('./float/float.cjs').Write,
    writeDouble: require('./double/double.cjs').Write,
