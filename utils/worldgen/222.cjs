...
function GenerateBlocks(world, socket, chunkX, chunkZ) {
    ...
    var snowID = utils.registry.block.GetBlockID(world, socket.thisPlayer.selectedRegistries.block, "snow_block")
    var grassID = utils.registry.block.GetBlockID(world, socket.thisPlayer.selectedRegistries.block, "grass_block")
    var iceID = utils.registry.block.GetBlockID(world, socket.thisPlayer.selectedRegistries.block, "ice")
...
function GetBlock(world, socket, blockPos) {
    if (blockPos.y == 0) return "snow_block"
