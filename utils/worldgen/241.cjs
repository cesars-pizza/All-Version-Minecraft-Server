...
function GenerateBlocks(world, socket, chunkX, chunkZ) {
    ...
    var groundID = utils.registry.block.GetBlockID(world, socket.thisPlayer.selectedRegistries.block, "cobblestone")
    var genericPlotFloorID = utils.registry.block.GetBlockID(world, socket.thisPlayer.selectedRegistries.block, "grass_block")
    var cornerID = utils.registry.block.GetBlockID(world, socket.thisPlayer.selectedRegistries.block, "gold_block")
